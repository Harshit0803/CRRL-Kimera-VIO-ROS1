FROM syanyong/ros-desktop:noetic-arm64
# FROM nvcr.io/nvidia/l4t-base:r32.4.4
LABEL maintainer="hs4851@nyu.edu"


# RUN apt-get install libnvinfer-bin=8.6.0.12-1+cuda11.8
# RUN apt-get install --no-install-recommends \ cuda-11-0 \ libcudnn8=8.0.5.39-1+cuda11.8  \ libcudnn8-dev=8.0.5.39-1+cuda11.8
...
# # Update apt-get sources AND install TensorRT
...
RUN python3 -m pip install --upgrade pip && \
   ...
   # cuda-python python3-libnvinfer-dev
# RUN python3 -m pip install -v nvidia-tensorrt
...
RUN /bin/bash -c "source $ROS_ROOT/setup.bash && catkin build"
